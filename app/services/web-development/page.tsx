    ...
    <>
      ...
      <section className="py-16 md:py-20 bg-white">
        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s) => (
              <div key={s.title} className="bg-blue-50/40 border border-blue-100 rounded-2xl p-7 hover:border-blue-200 hover:shadow-sm transition-all duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)]">
      ...
      <section className="py-14 bg-[#EFEFEF]">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-black text-[#111827] mb-6">What&apos;s Included in Every Project</h2>
          ...
          <div>
            <p className="text-sm font-bold text-[#6B7280] font-sans uppercase tracking-wider mb-3">Our Tech Stack</p>

    ...
    <>
      <section className="bg-[#FFFFFF] py-16 md:py-20 border-b border-gray-100">
        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <SectionBadge icon={Share2} text="Social Media Marketing
              " />
      ...
      <section className="py-16 bg-[#EFEFEF]">
        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black text-[#111827] mb-3">Platforms We Manage</h2>
            <p className="text-[#6B7280] font-sans max-w-xl mx-auto">Full-service social media management across all major platforms.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {platforms.map((p) => (
              <div key={p.name} className="bg-white rounded-2xl p-7 border border-gray-100 hover:shadow-sm transition-all duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)]">
      ...
      <section className="py-16 bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-black text-[#111827] text-center mb-10">What We Deliver</h2>

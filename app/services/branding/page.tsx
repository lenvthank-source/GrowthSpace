    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="axion-heading text-[clamp(1.5rem,4vw,3.2rem)] font-display font-bold text-[#111827] leading-tight mb-5">
                Build a Brand That{" "}
                <span className="text-[#F5A623]">People Remember.</span>
              </h1>
              ...
              <TextRollButton href="/contact" className="inline-flex items-center gap-2 bg-[#F5A623] hover:bg-[#D4901E] text-[#111827] font-semibold px-6 py-3.5 rounded-xl transition-colors shadow-md">Start Brand Project </TextRollButton>
            </div>
      ...
      <section className="py-20 bg-gray-950 text-center">
        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <TextRollButton href="/contact" className="inline-flex items-center gap-2 bg-[#F5A623] hover:bg-[#D4901E] text-[#111827] font-semibold px-8 py-4 rounded-xl transition-colors shadow-lg">Start Brand Project </TextRollButton>
        </div>
      </FadeIn>
      </section>
    </>

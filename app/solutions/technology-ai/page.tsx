    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/contact" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-7 py-3.5 rounded-xl transition-all duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)] shadow-lg shadow-blue-200">
                  Start a Project
      ...
      <section className="py-20 md:py-24 bg-white">
        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center mb-14">
            <h2 className="axion-heading text-[clamp(1.5rem,4vw,3.2rem)] font-display font-bold text-[#111827] mb-3">Technology Services</h2>
            <p className="text-[#6B7280] font-sans text-lg max-w-xl mx-auto">Four pillars of technology excellence, all under one roof.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {techCategories.map((cat) => {
              const Icon = cat.icon;
              return (
                <div key={cat.title} className="bg-[#EFEFEF] rounded-3xl p-8 border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)]">
                  <div className="flex items-center gap-3 mb-5">
                    <div className={`w-12 h-12 ${cat.color} rounded-2xl flex items-center justify-center shadow-md`}>
                      <Icon className="w-6 h-6 text-white" />
                    </div>
                    <h3 className="font-black text-[#111827] text-xl">{cat.title}</h3>
                  </div>
      ...
      <section className="py-20 bg-gray-950">
        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center mb-14">
            ...
            <h2 className="axion-heading text-[clamp(1.5rem,4vw,3.2rem)] font-display font-bold text-white mb-3">AI & Automation Spotlight</h2>
            <p className="text-[#6B7280] font-sans text-lg max-w-xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {aiHighlights.map((ai) => {
              const Icon = ai.icon;
              return (
                <Link key={ai.title} href={ai.href} className="group bg-white/5 border border-white/10 rounded-3xl p-7 hover:bg-white/[0.08] hover:border-violet-400/30 transition-all duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)]">
                  ...
                  <p className="text-[#6B7280] font-sans text-sm leading-relaxed">{ai.desc}</p>
      ...
      <section className="py-20 bg-blue-600 text-center">
        ...
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <Link href="/contact" className="inline-flex items-center gap-2 bg-white hover:bg-[#EFEFEF] text-blue-600 font-semibold px-8 py-4 rounded-xl transition-colors shadow-lg">
